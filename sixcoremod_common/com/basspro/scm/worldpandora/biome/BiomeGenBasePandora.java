...
public abstract class BiomeGenBasePandora
{
    /** An array of all the biomes, indexed by biome id. */
    public static final BiomeGenBasePandora[] biomeList = new BiomeGenBasePandora[256];
...
//        this.worldGeneratorSwamp = new WorldGenSwamp();
     ...
     */
    public BiomeGenBasePandora setTemperatureRainfall(float par1, float par2)
    {
     ...
     */
    public BiomeGenBasePandora setMinMaxHeight(float par1, float par2)
    {
        this.minHeight = par1;
        this.maxHeight = par2;
        return this;
     ...
     */
    public BiomeGenBasePandora setDisableRain()
    {
     ...
     */
    public BiomeGenBasePandora setEnableSnow()
    {
        this.enableSnow = true;
        return this;
    }

    public BiomeGenBasePandora setBiomeName(String par1Str)
    {
        this.biomeName = par1Str;
        return this;
    }

    public BiomeGenBasePandora func_76733_a(int par1)
    {
