...
public class WorldGenMinablePandora extends WorldGenerator
{
    ...
    public WorldGenMinablePandora(int par1, int par2)
    {
        this(par1, par2, Block.stone.blockID);
    }

    public WorldGenMinablePandora(int par1, int par2, int par3)
    {
    ...
    public WorldGenMinablePandora(int id, int meta, int number, int target)
    {
