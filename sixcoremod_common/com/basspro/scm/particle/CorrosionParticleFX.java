...
public class CorrosionParticleFX extends EntityFX
{
    public CorrosionParticleFX(World par1World, double par2, double par4, double par6, Item par8Item, RenderEngine par9RenderEngine)
    {
        super(par1World, par2, par4, par6, 0.0D, 0.0D, 0.0D);
        this.setParticleIcon(par9RenderEngine, par8Item.getIconFromDamage(0));
        this.particleGreen = 1.0F;
        this.particleBlue = this.particleRed = 0.0F;
        this.particleGravity = Block.blockSnow.blockParticleGravity;
        this.particleScale /= 2.0F;
    }
    
    public CorrosionParticleFX(World par1World, double par2, double par4, double par6, double par8, double par10, double par12, Item par14Item, RenderEngine par15RenderEngine)
    {
